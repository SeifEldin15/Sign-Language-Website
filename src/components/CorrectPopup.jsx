    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-[#293D46] rounded-lg p-8 shadow-xl max-w-sm w-full mx-4">
        <div className="text-center">
          <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-[#365148] mb-4">
            <svg className="h-8 w-8 text-[#58cc02]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
